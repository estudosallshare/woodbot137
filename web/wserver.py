...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      ...
      <div class="social">
        <a href="https://github.com/tele-v1/WOODcraft-v1"><i class="fab fa-github"></i></a>
...
@app.route('/')
def homepage():
    return "<h1>See WOODcraft-v1 <a href='https://github.com/tele-v1/WOODcraft-v1'>@GitHub</a> By <a href='https://github.com/tele-v1'>Code With WOODcraft-v1</a></h1>"
